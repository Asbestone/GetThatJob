...
function ResumeUpload() {
    ...
    try {
      ...
      if (result.error) {
        ...
        rawParsedJSON = rawParsedJSON
          ...
          .replace(/^```json\s*/, "")
          .replace(/```$/, "")
          .trim(); // removing the markdown comments
        ...
        // Parse JSON data for potential future use
        JSON.parse(rawParsedJSON);
        JSON.parse(rawFeatureJSON);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white">
      ...
      {fileContent && (
        <div
          className="mt-4 w-full max-w-4xl overflow-y-auto"
